...
//This is a test of the giant voice system. This is only a test. 
public class Cat {
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		//Imagine a cat with blue eyes. Now imagine that cat scratching. Beautfil, but still annoying. 
		x = catX + EYE_X; 
		y = catY + EYE_Y;
		...
		g2.fillOval(x, y, EYE_WIDTH, EYE_HEIGHT);
		// Draw the mouth
		g2.setColor(Color.CYAN);		//PURPLE ISNT A COLOR APPARENTLY
		//HOW IS LIGHTGRAY NOT A COLOR
		x = catX + MOUTH_X;
		y = catY + MOUTH_Y;
